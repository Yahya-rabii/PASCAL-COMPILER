...
private PrintWriter fluxCible;
    ...
    public void savePcode(){
        ...
        try {
            ...
            this.fluxCible = new PrintWriter(fw);

            // write to the file

            for (Instruction i  :  this.pcode) {
                this.fluxCible.println(i);
            }
    ...
    public void generer1(Mnemonique i ){
        ...
        this.getPcode().add(in);
    }


    public void generer2(Mnemonique i, int n){
        Instruction in  = new Instruction(i,n);
        this.getPcode().add(in);
    }
    ...
    public void block() throws Exception {
        ...
        this.getPcode().get(0).mne=Mnemonique.INT;
        this.getPcode().get(0).suite=((ScannerWS) this.get_scanner()).getOffset();
        insts();
    }
